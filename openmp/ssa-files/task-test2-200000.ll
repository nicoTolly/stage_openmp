...
%struct.anon = type { [200000 x float]* }
%struct.anon.0 = type { [200000 x float]* }
...
define i32 @main(i32, i8**) #0 {
  ...
  %5 = alloca i8**, align 8
  %6 = alloca [200000 x float], align 16
  %7 = alloca [200000 x float], align 16
...
; <label>:14:                                     ; preds = %11
  ...
  %22 = getelementptr inbounds [200000 x float], [200000 x float]* %6, i64 0, i64 %21
...
; <label>:26:                                     ; preds = %11
  ...
  call void (%ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%ident_t* @0, i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, [200000 x float]*)* @.omp_outlined. to void (i32*, i32*, ...)*), [200000 x float]* %6)
...
; Function Attrs: nounwind uwtable
define internal void @.omp_outlined.(i32* noalias, i32* noalias, [200000 x float]* dereferenceable(800000)) #0 {
  %4 = alloca i32*, align 8
  %5 = alloca i32*, align 8
  %6 = alloca [200000 x float]*, align 8
  %7 = alloca %struct.anon, align 8
  %8 = alloca %struct.anon.0, align 8
  store i32* %0, i32** %4, align 8
  store i32* %1, i32** %5, align 8
  store [200000 x float]* %2, [200000 x float]** %6, align 8
  %9 = load [200000 x float]*, [200000 x float]** %6, align 8
...
; <label>:14:                                     ; preds = %3
  ...
  store [200000 x float]* %9, [200000 x float]** %15, align 8
  ...
  store [200000 x float]* %9, [200000 x float]** %24, align 8
...
; <label>:23:                                     ; preds = %20
  ...
  %25 = srem i64 %24, 200000
  %26 = getelementptr inbounds %struct.anon, %struct.anon* %19, i32 0, i32 0
  %27 = load [200000 x float]*, [200000 x float]** %26, align 8
  %28 = getelementptr inbounds [200000 x float], [200000 x float]* %27, i64 0, i64 %25
